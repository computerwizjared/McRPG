          ...
          if(args[1].equalsIgnoreCase("abilitypoints")) {
            ...
            if(args.length < 5) {
              ...
              if(Methods.hasPlayerLoggedInBefore(args[2])) {
                if(!Methods.isInt(args[3])) {
                  ...
                  if (offlinePlayer.isOnline()) {
                    offlinePlayer.getPlayer().sendMessage(Methods.color((Player) offlinePlayer, plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Receive.RedeemableExp").replace("%Amount%", args[3])));
                  }
                  return true;
                }
              }
            ...
            if(Methods.hasPlayerLoggedInBefore(args[2])) {
              ...
              if (offlinePlayer.isOnline()) {
                ...
                p.sendMessage(Methods.color(plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Receive.Exp")
            ...
            if(args.length < 5) {
              ...
              if(Methods.hasPlayerLoggedInBefore(args[2])) {
                if(!Methods.isInt(args[3])) {
                  ...
                  if (offlinePlayer.isOnline()) {
                    offlinePlayer.getPlayer().sendMessage(Methods.color((Player) offlinePlayer, plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Receive.RedeemableLevels").replace("%Amount%", args[3])));
                  }
                  return true;
                }
              }
            ...
            if(Methods.hasPlayerLoggedInBefore(args[2])) {
              ...
              if (offlinePlayer.isOnline()) {
                ...
                p.sendMessage(Methods.color(plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Receive.Level")
                    .replace("%Amount%", args[3]).replace("%Skill%", skill.getDisplayName())));
              }
              mp.saveData();
              return true;
          ...
          if(args[1].equalsIgnoreCase("skill")) {
            ...
            if(Methods.hasPlayerLoggedInBefore(args[2])) {
              ...
              if (offlinePlayer.isOnline()) {
                ...
                p.sendMessage(Methods.color(plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Reset.SkillWasReset")
            ...
            if(Methods.hasPlayerLoggedInBefore(args[2])) {
              ...
              if (offlinePlayer.isOnline()) {
                ...
                p.sendMessage(Methods.color(plugin.getPluginPrefix() + config.getString("Messages.Commands.Admin.Reset.PlayerWasReset")));
              }
              mp.saveData();
              return true;
            }
